...
function saveUser($file, $name, $email, $username, $password) {
    ...
    file_put_contents($file, "$name:$email:$username:$hashedPassword\n", FILE_APPEND);
}
